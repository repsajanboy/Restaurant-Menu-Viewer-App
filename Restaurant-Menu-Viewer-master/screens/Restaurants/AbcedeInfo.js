        ...
        return (
            ...
            <ScrollView>
              ...
              <Card style={{marginTop: 5}}>
                <CardItem cardBody>
                  <UserMapAbcede style={{height: 200, width: '100%'}} userLocation={this.state.userLocation} />
                </CardItem>
                <CardItem>
                  <Left>
                    <Button transparent>
                      <Icon name="directions" type="MaterialIcons" style={{color: 'black', fontSize: 24}} />
                      <Text>Quezon Avenue Corner Balintawak St., Lucban, Quezon</Text>
                    </Button>
                  </Left>
                  <Right>
                    <Button bordered rounded info onPress={()=> Linking.openURL('google.navigation:q=14.1136306+121.5562406')}>
                ...
                <CardItem>
                  <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.openURL('tel: (042) 341 56 77')}} style={{fontSize: 16}}>(042) 341 56 77</Text>
                    </Button>
                  </Left>
                  <Right></Right>
                </CardItem>
                ...
                <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.canOpenURL("fb://facewebmodal/f?href=https://www.facebook.com/Kingmarkus091319").then(supported => {
                        if(supported){
                          return Linking.openURL("fb://facewebmodal/f?href=https://www.facebook.com/Kingmarkus091319");
                        } else {
                          return Linking.openURL("https://www.facebook.com/Kingmarkus091319");
                        }
                      })}}>Abcede's Resto</Text>
                    </Button>
                  </Left>
