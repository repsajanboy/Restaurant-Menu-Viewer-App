            ...
            <CardItem>
              ...
              <Right>
                <Button
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'google.navigation:q=14.11356148287954+121.55514933202329',
                    )
                  }>
            ...
            <CardItem>
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.openURL('tel: (042) 540 4841');
                    }}
                    style={{fontSize: 16}}>
                    (042) 540 4841
                  </Text>
              ...
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.canOpenURL(
                        'fb://facewebmodal/f?href=https://www.facebook.com/MacDaddysGrilledBurger',
                      ).then(supported => {
                        if (supported) {
                          ...
                          return Linking.openURL(
                            'https://www.facebook.com/MacDaddysGrilledBurger',
                          );
                        }
                      });
                    }}>
                    Mac Daddy's Grilled Burger
                  </Text>
                </Button>
              </Left>
              <Right />
