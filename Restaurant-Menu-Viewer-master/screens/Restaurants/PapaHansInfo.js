        ...
        return (
            ...
            <ScrollView>
              ...
              <Card style={{marginTop: 5}}>
                <CardItem cardBody>
                  <UsersMapPh style={{height: 200, width: '100%'}} userLocation={this.state.userLocation} />
                </CardItem>
                <CardItem>
                  <Left>
                    <Button transparent>
                  ...
                  <Right>
                    <Button bordered rounded info onPress={()=> Linking.openURL('google.navigation:q=14.11470554577507+121.557058095932')}>
                ...
                <CardItem>
                  <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.openURL('tel: 09988661023')}} style={{fontSize: 16}}>0998 866 1023</Text>
                    </Button>
                  </Left>
                  <Right></Right>
                </CardItem>
                <CardItem>
                  <Left>
                    <Button transparent>
                      <Icon name="message" type="MaterialIcons" style={{color: 'black', fontSize: 24}} />
                      <Text onPress={()=> {Linking.openURL('sms: 09988661023')}} style={{fontSize: 16}}>0998 866 1023</Text>
                    </Button>
                  </Left>
                  <Right></Right>
                </CardItem>
                <CardItem>
                  <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.canOpenURL("fb://facewebmodal/f?href=https://www.facebook.com/PH-Resto-1602317436719900PH-Resto-1602317436719900").then(supported => {
                        if(supported){
                          return Linking.openURL("fb://facewebmodal/f?href=https://www.facebook.com/PH-Resto-1602317436719900PH-Resto-1602317436719900");
                        } else {
                          return Linking.openURL("https://www.facebook.com/PH-Resto-1602317436719900");
                        }
                      })}}>PH Resto</Text>
                    </Button>
                  </Left>
