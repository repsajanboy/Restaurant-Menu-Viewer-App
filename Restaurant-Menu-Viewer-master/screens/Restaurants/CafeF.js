  ...
  constructor(props) {
    ...
    render() {
        ...
        <Tabs renderTabBar={()=> <ScrollableTab />}>
          <Tab heading={ <TabHeading><Text>Cold Drinks</Text></TabHeading>}>
          ...
          <Tab heading={ <TabHeading><Text>Coolers</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
          ...
          <Tab heading={ <TabHeading><Text>Flat Bread</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
          ...
          <Tab heading={ <TabHeading><Text>Frappe</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
          ...
          <Tab heading={ <TabHeading><Text>Hot Drinks</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
          ...
          <Tab heading={ <TabHeading><Text>Rice</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
          ...
          <Tab heading={ <TabHeading><Text>Rice Bowls</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
          ...
          <Tab heading={ <TabHeading><Text>Starters</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
          ...
          <Tab heading={ <TabHeading><Text>Wings</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
