            ...
            <CardItem>
              ...
              <Right>
                <Button
                  ...
                  info
                  onPress={() =>
                    Linking.openURL('google.navigation:q=14.111500+121.559887')
                  }>
            ...
            <CardItem>
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.openURL('tel: 09079971107');
                    }}
                    style={{fontSize: 16}}>
                    0907 997 1107
                  </Text>
            ...
            <CardItem>
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.openURL('sms: 09079971107');
                    }}
                    style={{fontSize: 16}}>
                    0907 997 1107
                  </Text>
              ...
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.canOpenURL(
                        'fb://facewebmodal/f?href=https://www.facebook.com/KuboSizzlers2/',
                      ).then(supported => {
                        if (supported) {
                          ...
                          return Linking.openURL(
                            'https://www.facebook.com/KuboSizzlers2/',
                          );
                        }
                      });
                    }}>
