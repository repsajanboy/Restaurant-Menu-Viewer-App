        ...
        return (
            ...
            <ScrollView>
              ...
              <Card style={{marginTop: 5}}>
                <CardItem cardBody>
                  <UsersMapRma style={{height: 200, width: '100%'}} userLocation={this.state.userLocation} />
                </CardItem>
                <CardItem>
                  <Left>
                    <Button transparent>
                  ...
                  <Right>
                    <Button bordered rounded info onPress={()=> Linking.openURL('google.navigation:q=14.1147361+121.5545583')}>
                ...
                <CardItem>
                  <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.openURL('tel: 09391784280')}} style={{fontSize: 16}}>0939 178 4280</Text>
                    </Button>
                  </Left>
                  <Right></Right>
                </CardItem>
                <CardItem>
                  <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.openURL('sms: 09391784280')}} style={{fontSize: 16}}>0939 178 4280</Text>
                    </Button>
                  </Left>
                  <Right></Right>
                </CardItem>
                <CardItem>
                  <Left>
                      <Button transparent>
                        ...
                        <Text onPress={()=> {Linking.canOpenURL("fb://facewebmodal/f?href=www.facebook.com/RMAkitchen").then(supported => {
                          if(supported){
                            return Linking.openURL("fb://facewebmodal/f?href=www.facebook.com/RMAkitchen");
                          } else {
                            return Linking.openURL("https://www.facebook.com/RMAkitchen");
                          }
                        })}}>RMA Kitchen</Text>
                      </Button>
                    </Left>
