        ...
        return (
            ...
            <ScrollView>
              ...
              <Card style={{marginTop: 5}}>
                <CardItem cardBody>
                  <UsersMapChitos style={{height: 200, width: '100%'}} userLocation={this.state.userLocation} />
                </CardItem>
                <CardItem>
                  <Left>
                    <Button transparent>
                  ...
                  <Right>
                    <Button bordered rounded info onPress={()=> Linking.openURL('google.navigation:q=14.1132778+121.5569927')}>
                ...
                <CardItem>
                  <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.openURL('tel: 7192850')}} style={{fontSize: 16}}>7192850</Text>
                    </Button>
                  </Left>
                  <Right></Right>
                </CardItem>
                <CardItem>
                  <Left>
                      <Button transparent>
                        ...
                        <Text onPress={()=> {Linking.canOpenURL("fb://facewebmodal/f?href=https://www.facebook.com/CHITOSuulitkasasaraptoo").then(supported => {
                          if(supported){
                            return Linking.openURL("fb://facewebmodal/f?href=https://www.facebook.com/CHITOSuulitkasasaraptoo");
                          } else {
                            return Linking.openURL("https://www.facebook.com/CHITOSuulitkasasaraptoo");
                          }
                        })}}>CHITO'S</Text>
                      </Button>
                    </Left>
