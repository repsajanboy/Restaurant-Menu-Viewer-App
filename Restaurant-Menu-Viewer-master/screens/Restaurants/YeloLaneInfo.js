            ...
            <CardItem>
              ...
              <Right>
                <Button
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'google.navigation:q=14.1129396+121.5556736',
                    )
                  }>
              ...
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.canOpenURL(
                        'fb://facewebmodal/f?href=https://www.facebook.com/yelolane',
                      ).then(supported => {
                        if (supported) {
                          ...
                          return Linking.openURL(
                            'https://www.facebook.com/yelolane',
                          );
                        }
                      });
                    }}>
