        ...
        return (
            ...
            <ScrollView>
              ...
              <Card style={{marginTop: 5}}>
                <CardItem cardBody>
                  <UserMapPepet style={{height: 200, width: '100%'}} userLocation={this.state.userLocation} />
                </CardItem>
                <CardItem>
                  <Left>
                    <Button transparent>
                  ...
                  <Right>
                    <Button bordered rounded info onPress={()=> Linking.openURL('google.navigation:q=14.1132927+121.5544781')}>
                ...
                <CardItem>
                  <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.openURL('tel: 0917 427 0014')}} style={{fontSize: 16}}>0917 427 0014</Text>
                    </Button>
                  </Left>
                  <Right></Right>
                </CardItem>
                <CardItem>
                  <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.openURL('sms: 0917 427 0014')}} style={{fontSize: 16}}>0917 427 0014</Text>
                    </Button>
                  </Left>
                  <Right></Right>
                </CardItem>
                ...
                <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.canOpenURL("fb://facewebmodal/f?href=https://www.facebook.com/pepetarens/").then(supported => {
                        if(supported){
                          return Linking.openURL("fb://facewebmodal/f?href=https://www.facebook.com/pepetarens/");
                        } else {
                          return Linking.openURL("https://www.facebook.com/pepetarens/");
                        }
                      })}}>Pepet</Text>
                    </Button>
                  </Left>
