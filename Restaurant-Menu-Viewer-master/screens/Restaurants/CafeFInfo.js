...
import CafeFSlider from '../../components/Sliders/CafeFSlider';

export default class CafeFInfo extends React.Component {
  state = {
    userLocation: null
  }
              ...
              <Card style={{marginTop: 5}}>
                ...
                <CardItem>
                  <Left>
                    <Button transparent>
                      ...
                      <Text>Unit 2F Building Miramonte Subdivision, Lucban, Quezon</Text>
                    </Button>
                  </Left>
                  <Right>
                    <Button bordered rounded info onPress={()=> Linking.openURL('google.navigation:q=14.1120549+121.5593467')}>
                ...
                <CardItem>
                  <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.openURL('tel: 0995 275 7509')}} style={{fontSize: 16}}>0995 275 7509</Text>
                    </Button>
                  </Left>
                  <Right></Right>
                </CardItem>
                ...
                <Left>
                    <Button transparent>
                      ...
                      <Text onPress={()=> {Linking.canOpenURL("fb://facewebmodal/f?href=https://www.facebook.com/Café-Florentina-436518363422161").then(supported => {
                        if(supported){
                          return Linking.openURL("fb://facewebmodal/f?href=https://www.facebook.com/Café-Florentina-436518363422161");
                        } else {
                          return Linking.openURL("https://www.facebook.com/Café-Florentina-436518363422161");
                        }
                      })}}>Cafe Florentina</Text>
                    </Button>
                  </Left>
                  <Right></Right>
                </CardItem>
