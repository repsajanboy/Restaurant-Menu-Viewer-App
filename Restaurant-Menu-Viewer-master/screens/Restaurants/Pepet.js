  ...
  constructor(props) {
    ...
    render() {
        ...
        <Tabs renderTabBar={()=> <ScrollableTab />}>
          <Tab heading={ <TabHeading><Text>Minandal</Text></TabHeading>}>
          ...
          <Tab heading={ <TabHeading><Text>Pancit</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
          ...
          <Tab heading={ <TabHeading><Text>Ulam</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
          ...
          <Tab heading={ <TabHeading><Text>Extra</Text></TabHeading>}>
            <Container style={{backgroundColor: '#dfdfdf', padding: 10}} >
              <FlatList
              data={this.state.item}
              //Item Separator View
