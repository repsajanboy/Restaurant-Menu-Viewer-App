            ...
            <CardItem>
              ...
              <Right>
                <Button
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'google.navigation:q=14.1148821+121.5548852',
                    )
                  }>
            ...
            <CardItem>
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.openURL('tel: (042) 540 5047');
                    }}
                    style={{fontSize: 16}}>
                    (042) 540 5047
                  </Text>
              ...
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.canOpenURL(
                        'fb://facewebmodal/f?href=https://www.facebook.com/Onyoks-Bulaluhan-140958996842901/',
                      ).then(supported => {
                        if (supported) {
                          ...
                          return Linking.openURL(
                            'https://www.facebook.com/Onyoks-Bulaluhan-140958996842901/',
                          );
                        }
                      });
                    }}>
