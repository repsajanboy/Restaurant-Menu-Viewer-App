            ...
            <CardItem>
              ...
              <Right>
                <Button
                  ...
                  info
                  onPress={() =>
                    Linking.openURL('google.navigation:q=14.115834+121.553517')
                  }>
              ...
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.canOpenURL(
                        'https://www.cbarlucban.blogspot.com',
                      ).then(supported => {
                        if (supported) {
            ...
            <CardItem>
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.openURL('tel: (042) 540 6288');
                    }}
                    style={{fontSize: 16}}>
                    {' '}
                    (042) 540 6288
              ...
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.canOpenURL(
                        'fb://facewebmodal/f?href=https://www.facebook.com/Cbarlucban',
                      ).then(supported => {
                        if (supported) {
                          return Linking.openURL(
                            'fb://facewebmodal/f?href=https://www.facebook.com/Cbarlucban',
                          ...
                          return Linking.openURL(
                            'https://www.facebook.com/Cbarlucban',
                          );
                        }
                      });
                    }}>
                    C Bar + Restaurant Lucban
                  </Text>
                </Button>
              </Left>
              <Right />
