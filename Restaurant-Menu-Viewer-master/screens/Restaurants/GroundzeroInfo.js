            ...
            <CardItem>
              <Left>
                <Button transparent>
                  ...
                  />
                  <Text>
                    Quezon Avenue Corner Regidor St., Lucban, Quezon Province
                  </Text>
                </Button>
              </Left>
              <Right>
                <Button
                  ...
                  onPress={() =>
                    Linking.openURL(
                      'google.navigation:q=14.1140032+121.5551148',
                    )
                  }>
            ...
            <CardItem>
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.openURL('tel: (042) 540 9615');
                    }}
                    style={{fontSize: 16}}>
                    (042) 540 9615
                  </Text>
              ...
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.canOpenURL(
                        'fb://facewebmodal/f?href=https://www.facebook.com/pages/Ground-Zero-House-of-Pizza/1820171281640334',
                      ).then(supported => {
                        if (supported) {
                          ...
                          return Linking.openURL(
                            'https://www.facebook.com/pages/Ground-Zero-House-of-Pizza/1820171281640334',
                          );
                        }
                      });
                    }}>
