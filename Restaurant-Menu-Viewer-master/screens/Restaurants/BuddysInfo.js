            ...
            <CardItem>
              <Left>
                <Button transparent>
                  ...
                  />
                  <Text>
                    99 Rizal Avenue, corner San Luis, St, Lucban, Quezon
                  </Text>
                </Button>
              </Left>
              <Right>
                <Button
                  ...
                  info
                  onPress={() =>
                    Linking.openURL('google.navigation:q=14.1146135+121.554745')
                  }>
            ...
            <CardItem>
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.openURL('tel: (042) 540 3394');
                    }}
                    style={{fontSize: 16}}>
                    (042) 540 3394
                  </Text>
            ...
            <CardItem>
              <Left>
                <Button transparent>
                  ...
                  <Text
                    onPress={() => {
                      Linking.canOpenURL('https://www.buddys.com.ph').then(
                        supported => {
                          if (supported) {
