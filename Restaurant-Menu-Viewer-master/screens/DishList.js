...
import { Thumbnail, Button, Left, Right, Body, Icon, Text, Container, Header, Content, List, ListItem, CardItem,  } from 'native-base';
  ...
  renderItem(item) {
    ...
    <View>
      <List style={{backgroundColor: "white"}}>
        <ListItem thumbnail style={{marginBottom: 5}} button onPress={()=>this.openModal2(item.name)}>
          <Left>
            ...
            >
              <FlatList
                ...
                <Card>
                  ...
                  <CardItem>
                    <Left style={{flex: 2}}>
                      <Button transparent onPress={()=>this.navigateRestaurant(item.navi)}>
